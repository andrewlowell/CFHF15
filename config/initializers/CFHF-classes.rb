  CLASSES = [
              ...
              [
                ...
                ["LDS Research Ideas: Family Discovery Day --Priesthood and Auxiliaries Session (Video - Room 1)"],
                ...
                ["Choreograph Your Research Across the Internet (Video - Room 3)"],
                #["FamilySearch Indexing: It's a Whole New World! (Video - Room 3)"],
                ["1-on-1 Research Help (Room 4)"]
              ],
              
              [
                ["Building a Genealogy Research Toolbox - Thomas MacEntee (Video - Chapel)"],
                ["FamilySearch Family Tree Now and in the Future (Video - Relief Society Room)"],
                ...
                ["You've Mastered the Census and Basic Search, What Next? (Video - Room 3)"],
